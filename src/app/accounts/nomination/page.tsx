...
export default function NSDLNominationPage() {
  return (
    <div className="min-h-screen bg-[#020817] text-white overflow-hidden relative">
      ...
      {/* BACKGROUND */}
      <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 via-transparent to-blue-500/10 blur-3xl"></div>
      ...
      <section className="relative py-24 px-6">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            {/* DESCRIPTION */}
            <p className="text-slate-400 text-lg leading-9 mb-12 max-w-2xl">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-[40px] overflow-hidden shadow-2xl">
              ...
              <div className="bg-gradient-to-r from-red-500 to-red-600 p-8">
                ...
                <p className="text-white/90 text-sm leading-7 mb-5">
                  Secure online nomination update facility provided through
                  the official NSDL e-Services platform with protected
                  authentication and investor verification.
                </p>
                ...
                <div className="space-y-8">
                  ...
                  <div className="pt-6">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-red-500 to-red-600 hover:opacity-90 transition-all duration-300 py-5 rounded-2xl text-lg font-bold"
                    >
                      Continue to Official NSDL Login
